...
public class Get06 extends RestfulBaseUrl {
    ...
    /*
        ...
        When
            User send a GET request to the URL   //   Kullanıcı URL'ye bir GET isteği gönderir
        Then
            HTTP Status Code should be 200                   olmalıdır

        And        Response content type is "application/json"    //         Yanıt içerik türü "application/json"
        And
            Response body should be like;                      Ve
                                                        Tepki gövdesi şöyle olmalıdır;
         {
    "firstname": "Bradley",
    "lastname": "Pearson",
    "totalprice": 132,
